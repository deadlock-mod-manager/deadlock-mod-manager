...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/deadlock-mod-manager/deadlock-mod-manager/releases/latest">Télécharger</a>
    ·
    <a href="https://docs.deadlockmods.app/">Documentation</a>
    ·
    <a href="https://github.com/deadlock-mod-manager/deadlock-mod-manager/issues/new?labels=bug&template=bug-report---.md">Signaler un Bug</a>
    ·
    <a href="https://github.com/deadlock-mod-manager/deadlock-mod-manager/issues/new?labels=enhancement&template=feature-request---.md">Demander une Fonctionnalité</a>
  </p>
...
<details>
  ...
  <ol>
    ...
    <li><a href="#traduction--localisation">Traduction & Localisation</a></li>
...
- [Communauté Discord](https://deadlockmods.app/discord)
- [Signaler des Problèmes](https://github.com/deadlock-mod-manager/deadlock-mod-manager/issues)
...
<details>
  <summary><strong>Langues actuellement supportées</strong></summary>
...
1. **Rejoignez notre serveur Discord** : D'abord [rejoignez notre serveur Discord](https://deadlockmods.app/discord), pour accéder aux canaux de traduction
...
Pour des directives de contribution complètes, la configuration du développement, les standards de style de code et les meilleures pratiques, veuillez consulter :

- **[CONTRIBUTING.md](CONTRIBUTING.md)**
- **[Documentation de Contribution](https://docs.deadlockmods.app/developer-docs/contributing)**
...
**Avertissement :** Ce projet n'est pas affilié à Valve Corporation. Deadlock et le logo Deadlock sont des marques déposées de Valve Corporation.

## Contact

- **Dépôt du Projet** : [GitHub](https://github.com/deadlock-mod-manager/deadlock-mod-manager)
- **Issues & Rapports de Bugs** : [GitHub Issues](https://github.com/deadlock-mod-manager/deadlock-mod-manager/issues)
- **Demandes de Fonctionnalités** : [GitHub Discussions](https://github.com/deadlock-mod-manager/deadlock-mod-manager/discussions)
- **Communauté Discord** : [Rejoignez notre Discord](https://deadlockmods.app/discord)
- **Auteur** : [Stormix](https://github.com/Stormix)

Pour le support et les questions, veuillez utiliser GitHub Issues ou rejoindre notre communauté Discord. Nous sommes toujours heureux d'aider !

<!-- ACKNOWLEDGMENTS -->

## Remerciements

Ce projet n'a été possible que grâce à l'incroyable communauté open source, notamment :

### Remerciements Spéciaux

- **[GameBanana](https://gamebanana.com/)** - Notre source principale de mods et la colonne vertébrale de cette application. GameBanana fournit la base de données de mods complète et l'API qui rend possible la navigation, la découverte et le téléchargement de mods Deadlock. Ce projet n'existerait pas sans leur excellente plateforme et leur contenu communautaire.
...
<p align="center">
  Signature de code gratuite sur Windows fournie par <a href="https://signpath.io/?utm_source=foundation&utm_medium=github&utm_campaign=deadlock-mod-manager">SignPath.io</a><br/>
  Certificat par <a href="https://signpath.org/?utm_source=foundation&utm_medium=github&utm_campaign=deadlock-mod-manager">SignPath Foundation</a>
</p>
