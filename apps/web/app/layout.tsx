...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        'The official mod manager for Deadlock. Easily browse, install and manage mods and skins for your game. Enhance your gaming experience with community-created content.',
    ...
    twitter: {
      ...
      title: `Deadlock Mod Manager v${version} - Easy Mod Installation & Management`,
      description:
        'The official mod manager for Deadlock. Easily browse, install and manage mods and skins for your game.',
      images: ['/og-image.png'],
      creator: '@stormix_dev',
    },
  };
