...
export const envSchema = z.object({
  ...
  WORKER_PORT: z.coerce.number().min(1).max(65535).default(9001),
  ...
  DEADWORKS_REGISTRY_URL: z
    .string()
    .url("DEADWORKS_REGISTRY_URL must be a valid URL")
    .default("https://api.deadworks.net"),
});
