...
<Callout type="info" title="Recommended Approach">
  The translation helper script is the easiest way to contribute translations. It guides you through every step and handles all the technical setup automatically.
</Callout>
