...
We use AI tools in our development workflow and encourage contributors to use them
responsibly as well. See our [AI Policy](https://github.com/deadlock-mod-manager/deadlock-mod-manager/blob/main/AI_POLICY.md)
for guidelines.

AI agents working on this codebase should also read [AGENTS.md](https://github.com/deadlock-mod-manager/deadlock-mod-manager/blob/main/AGENTS.md)
