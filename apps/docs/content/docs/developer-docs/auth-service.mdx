...
For local development without Steam credentials, a dev authentication system is available that allows email/password login with test accounts.

See [Dev Authentication](/docs/developer-docs/dev-authentication) for setup instructions.
