...
pub async fn create_server_addons_folder(server_id: String) -> Result<String, Error> {
  crate::game_guard::ensure_game_idle_locked("create_server_addons_folder")?;
...
pub async fn delete_server_addons_folder(server_id: String) -> Result<(), Error> {
  crate::game_guard::ensure_game_idle_locked("delete_server_addons_folder")?;
...
pub async fn apply_server_gameinfo(
  ...
  crate::game_guard::ensure_game_idle_locked("apply_server_gameinfo")?;
