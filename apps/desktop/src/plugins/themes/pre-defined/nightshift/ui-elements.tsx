...
const cornerTopLeft = getPluginAssetUrl(
  "themes",
  "public/pre-defined/nightshift/svg/corner_top_left.svg",
);
const cornerTopRight = getPluginAssetUrl(
  "themes",
  "public/pre-defined/nightshift/svg/corner_top_right.svg",
);
const cornerBottomLeft = getPluginAssetUrl(
  "themes",
  "public/pre-defined/nightshift/svg/corner_bottom_left.svg",
);
const cornerBottomRight = getPluginAssetUrl(
  "themes",
  "public/pre-defined/nightshift/svg/corner_bottom_right.svg",
);
