...
const HostServerCta = ({ className }: HostServerCtaProps) => {
  ...
  return (
    <div
      className={cn(
        "flex flex-wrap items-center gap-3 rounded-md border border-primary/30 bg-linear-to-r from-primary/10 via-card/60 to-card/40 px-4 py-2.5 ring-1 ring-primary/10",
        className,
      )}
